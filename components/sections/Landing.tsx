  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute bottom-24 left-1/2 -translate-x-1/2 flex flex-row gap-6 md:bottom-auto md:right-12 md:left-auto md:translate-x-0 md:top-1/2 md:-translate-y-1/2 md:flex-col z-[60]"
        role="navigation"
      ...
      >
        ...
        <motion.a
          ...
          className="group relative p-4 bg-black/80 backdrop-blur-md rounded-full border-2 border-white/30 hover:border-cyan-400 hover:bg-cyan-400/10 transition-all duration-300 shadow-lg hover:shadow-cyan-400/50"
          aria-label="GitHub Profile"
          whileHover={{ scale: 1.1, transition: { duration: 0.2 } }}
          whileTap={{ scale: 0.95 }}
          style={{ pointerEvents: 'auto' }}
        >
          <svg className="w-6 h-6 text-white group-hover:text-cyan-400 transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
